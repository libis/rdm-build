...
build:build-mailcatcher build-proxy build-dataverse ## Build all custom docker images

push: push-mailcatcher push-proxy push-dataverse ## Publish all custom docker images
